...
public class AudioController:MonoBehaviour
{
    ...
    internal bool MusicMuted {
        ...
        set {
            ...
            if(this.isMusicMuted) {
                FMODUnity.RuntimeManager.GetVCA("vca:/MUSICA_FADE").setVolume(0);
            } else {
                FMODUnity.RuntimeManager.GetVCA("vca:/MUSICA_FADE").setVolume(1);
            }
        }
    }
    ...
    internal bool SFXMuted {
        ...
        set {
            ...
            if(this.isSFXMuted) {
                FMODUnity.RuntimeManager.GetVCA("vca:/SFX").setVolume(0);
            } else {
                FMODUnity.RuntimeManager.GetVCA("vca:/SFX").setVolume(1);
            }
        }
    }
    ...
    internal bool DubMuted {
        ...
        set {
            ...
            if(this.isDubMuted) {
                FMODUnity.RuntimeManager.GetVCA("vca:/DUB").setVolume(0);
            } else {
                FMODUnity.RuntimeManager.GetVCA("vca:/DUB").setVolume(1);
            }
        }
    }
